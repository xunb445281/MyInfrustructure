...
namespace Standard.Infrastructure.Encryptions
{
    ...
    public class RsaOpenSSLHelper
    {
        ...
        public string Decrypt(string cipherText)
        {
            ...
            return Encoding.UTF8.GetString(privateKeyRsaProvider.Decrypt(System.Convert.FromBase64String(cipherText), RSAEncryptionPadding.Pkcs1));
        }
        ...
        public string Encrypt(string text)
        {
            ...
            return System.Convert.ToBase64String(publicKeyRsaProvider.Encrypt(Encoding.UTF8.GetBytes(text), RSAEncryptionPadding.Pkcs1));
        }
